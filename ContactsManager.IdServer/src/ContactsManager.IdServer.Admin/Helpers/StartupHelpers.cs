...
using Serilog;
using ContactsManager.IdServer.Admin.ExceptionHandling;
using ContactsManager.IdServer.Admin.Middlewares;
using ContactsManager.IdServer.Admin.Configuration;
using ContactsManager.IdServer.Admin.Configuration.Constants;
using ContactsManager.IdServer.Admin.Configuration.Interfaces;

namespace ContactsManager.IdServer.Admin.Helpers
{
